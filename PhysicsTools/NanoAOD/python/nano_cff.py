...
nanoSequence = cms.Sequence(
        ...
        linkedObjects  +
        jetTables + muonTables + BToKmumuTable + tauTables + electronTables + photonTables +  globalTables +vertexTables+ metTables+simpleCleanerTable + triggerObjectTables + isoTrackTables +
	l1bits)
